...
전에 풀었던 문제랑 비슷한것 같아서 날로먹을려고 복붙했다가 3연속 실패가 떠서 화가 났다.<br>
알고보니까 그 문제는 큐 구조였고, 이 문제는 스택 구조라서 코드가 약간 다르다고 한다.
<br>
스택은 Last in First Out (LIFO) 구조라서 먼저 들어온 자료가 맨 아래에 깔려 가장 나중에 나간다고 한다.
<br>
근데 이게 왜 되지?
