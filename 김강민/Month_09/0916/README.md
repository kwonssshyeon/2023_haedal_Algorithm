...
1. total_price 변수를 만들고 초기화 한다.
2. for문을 1~count 만큼 돌린다.
3. total_price에 i 만큼 계속 곱한값을 더해준다.
4. total_price가 money보다 작으면, 금액이 부족하지 않기 때문에 0을 출력한다.
5. money보다 크다면 total_price에서 money를 뺀 값을 출력한다.
