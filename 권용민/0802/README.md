...
일반적인 플로이드-워셜 알고리즘!<br>
주의할 점은 input이 많기 때문에 sys.stdin.readline() 쓰는 것과, <br>
주어진 각 cost의 최대값이 100000이라는게 최종 각 최단경로가 100000 이하라는게 아니라는 것.<br>
sys.maxsize 사용해서 해결했다
